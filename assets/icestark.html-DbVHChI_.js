import{_ as l,r as c,o as d,c as p,a as s,b as n,d as e,e as i}from"./app-DgIu4VEv.js";const r={},t=s("h3",{id:"_1-1、介绍",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#_1-1、介绍"},[s("span",null,"1.1、介绍")])],-1),v={href:"https://github.com/ice-lab/icestark",target:"_blank",rel:"noopener noreferrer"},u=i(`<ul><li>后台比较分散，体验差别大，因为要频繁跳转导致操作效率低，希望能统一收口的一个系统内</li><li>单页面应用非常庞大，多人协作成本高，开发/构建时间长，依赖升级回归成本高</li><li>系统有二方/三方接入的需求</li></ul><p><img src="https://s2.loli.net/2024/06/29/MyXdKEZ6eqp3CRh.png" alt="2.png"></p><h3 id="_1-2、项目结构" tabindex="-1"><a class="header-anchor" href="#_1-2、项目结构"><span>1.2、项目结构</span></a></h3><h1 id="_2、icestark-工作流程" tabindex="-1"><a class="header-anchor" href="#_2、icestark-工作流程"><span>2、icestark 工作流程</span></a></h1><p>icestark 目前支持三种加载模式，分别是 <code>script</code>、<code>fetch</code> 和 <code>import</code></p><ul><li><code>script</code></li></ul><p>默认加载方式。该模式下，icestark 会通过 HTML script 标签加载微应用脚本资源，再次加载时充分利用浏览器缓存进行加载。</p><ul><li><code>fetch</code></li></ul><p>当指定 loadScriptMode 为 fetch，或配置微应用沙箱模式时，会通过 window.fetch 或用户自定义的 fetch 能力 加载并缓存脚本资源。再次加载时，会充分利用本地内部缓存进行加载。</p><ul><li><code>import</code></li></ul><p>加载 ES modules 类型微应用的主要方式，该模式会通过 Dynamic Import 动态加载脚本资源。</p><p>推荐使用 <code>import</code> 当前项目模板也是采用 <code>import</code> 模式进行加载微应用</p><p><img src="https://s2.loli.net/2024/06/23/FTCl21fnpikmBwG.jpg" alt="icestark.jpg"></p><h3 id="_2-1、项目结构图" tabindex="-1"><a class="header-anchor" href="#_2-1、项目结构图"><span>2.1、项目结构图</span></a></h3><p><img src="https://s2.loli.net/2024/06/29/ysAuXbQ2dVmfUB4.png" alt="1.png"></p><h1 id="_3、vue-主应用接入" tabindex="-1"><a class="header-anchor" href="#_3、vue-主应用接入"><span>3、Vue 主应用接入</span></a></h1><h3 id="_3-1、主应用框架目录规范" tabindex="-1"><a class="header-anchor" href="#_3-1、主应用框架目录规范"><span>3.1、主应用框架目录规范</span></a></h3><div class="language-Shell line-numbers-mode" data-ext="Shell" data-title="Shell"><pre class="language-Shell"><code><span class="line">── project-name                      项目名称</span>
...
<span class="line">   ···</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2、安装-icestark-依赖" tabindex="-1"><a class="header-anchor" href="#_3-2、安装-icestark-依赖"><span>3.2、安装 icestark 依赖</span></a></h3><div class="language-Shell line-numbers-mode" data-ext="Shell" data-title="Shell"><pre class="language-Shell"><code><span class="line">npm i --save @ice/stark</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_3-3、配置微应用加载方式和地址" tabindex="-1"><a class="header-anchor" href="#_3-3、配置微应用加载方式和地址"><span>3.3、配置微应用加载方式和地址</span></a></h3><p>在 <strong>src/micro/apps.js</strong> 里面进行配置，采用 <code>import</code> 的形式进行加载</p><h5 id="_3-3-1、配置路径" tabindex="-1"><a class="header-anchor" href="#_3-3-1、配置路径"><span>3.3.1、配置路径</span></a></h5><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">── project-name</span>
<span class="line">   ├── src</span>
<span class="line">   │   ├── micro</span>
<span class="line">   │   │   └── apps.js       子站加载配置地址</span>
<span class="line">   ...</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_3-3-2、参考配置" tabindex="-1"><a class="header-anchor" href="#_3-3-2、参考配置"><span>3.3.2、参考配置</span></a></h5><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">export default function (appContainer) {</span>
...
<span class="line">  ];</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-4、子站地址配置环境变量" tabindex="-1"><a class="header-anchor" href="#_3-4、子站地址配置环境变量"><span>3.4、子站地址配置环境变量</span></a></h3><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">// 开发环境</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-5、定义基准路由" tabindex="-1"><a class="header-anchor" href="#_3-5、定义基准路由"><span>3.5、定义基准路由</span></a></h3><h5 id="_3-5-1、配置路径" tabindex="-1"><a class="header-anchor" href="#_3-5-1、配置路径"><span>3.5.1、配置路径</span></a></h5><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">── project-name</span>
...
<span class="line">   │   │   │   │···</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_3-5-2、参考配置" tabindex="-1"><a class="header-anchor" href="#_3-5-2、参考配置"><span>3.5.2、参考配置</span></a></h5><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">import { createRouter, createWebHistory } from &quot;vue-router&quot;;</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-6、配置微应用路由" tabindex="-1"><a class="header-anchor" href="#_3-6、配置微应用路由"><span>3.6、配置微应用路由</span></a></h3><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">export default [</span>
<span class="line">  {</span>
...
<span class="line">  },</span>
<span class="line">];</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-7、在导航组件-注册微应用" tabindex="-1"><a class="header-anchor" href="#_3-7、在导航组件-注册微应用"><span>3.7、在导航组件，注册微应用</span></a></h3><p>在 src/layout/index.vue 里面通过 <code>registerMicroApps</code> 来注册微应用</p><div class="language-HTML line-numbers-mode" data-ext="HTML" data-title="HTML"><pre class="language-HTML"><code><span class="line">&lt;template&gt;</span>
...
<span class="line">}</span>
<span class="line">&lt;/style&gt;</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_4、vue-微应用接入" tabindex="-1"><a class="header-anchor" href="#_4、vue-微应用接入"><span>4、Vue 微应用接入</span></a></h1><h3 id="_4-1、安装-icestark-依赖" tabindex="-1"><a class="header-anchor" href="#_4-1、安装-icestark-依赖"><span>4.1、安装 icestark 依赖</span></a></h3><div class="language-Shell line-numbers-mode" data-ext="Shell" data-title="Shell"><pre class="language-Shell"><code><span class="line">npm i @ice/stark @ice/stark-app -S</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-2、安装-vite-plugin-index-html" tabindex="-1"><a class="header-anchor" href="#_4-2、安装-vite-plugin-index-html"><span>4.2、安装 vite-plugin-index-html</span></a></h3><div class="language-SQL line-numbers-mode" data-ext="SQL" data-title="SQL"><pre class="language-SQL"><code><span class="line">npm i vite-plugin-index-html  -D</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>通过插件配置使打包生成支持 import 格式的文件，由于使用 <code>vite-plugin-index-html</code> 替换 <code>vite-plugin-html</code> 导致打包不能配置变量，也就不能配置环境变量，需要将子站的环境变量统一放到主站里面</p><p>在 vit.config.js 里面新增配置</p><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">import htmlPlugin from &quot;vite-plugin-index-html&quot;;</span>
<span class="line"></span>
...
<span class="line">    })</span>
<span class="line">});</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3、应用入口适配" tabindex="-1"><a class="header-anchor" href="#_4-3、应用入口适配"><span>4.3、应用入口适配</span></a></h3><p>在 main.js 中进行调整，支持 <code>umd</code> 格式导出 <code>mount/unmount</code> 方法进行挂载和卸载，兼容非 icestark 环境的情况下执行 vue 的挂载</p><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">import { createApp } from &quot;vue&quot;;</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-4、定义基准路由" tabindex="-1"><a class="header-anchor" href="#_4-4、定义基准路由"><span>4.4、定义基准路由</span></a></h3><p>vue-router base 路径兼容处理支持 icestark 环境运行和默认环境运行</p><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">import { createRouter, createWebHistory } from &quot;vue-router&quot;;</span>
<span class="line">import routers from &quot;./router&quot;;</span>
<span class="line">import { getBasename } from &quot;@ice/stark-app&quot;;</span>
...
<span class="line"></span>
<span class="line">export default router;</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-5、定义基准路由" tabindex="-1"><a class="header-anchor" href="#_4-5、定义基准路由"><span>4.5、定义基准路由</span></a></h3><p>在 vite.config.js 中配置 base 地址， base 地址和域名后缀以及主站加载子站的 name 相同</p><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">import { defineConfig } from &quot;vite&quot;;</span>
<span class="line"></span>
<span class="line">export default defineConfig({</span>
<span class="line">  base: &quot;/sme/&quot;,</span>
<span class="line">});</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_5、项目模板" tabindex="-1"><a class="header-anchor" href="#_5、项目模板"><span>5、项目模板</span></a></h1><h3 id="_5-1、应用技术" tabindex="-1"><a class="header-anchor" href="#_5-1、应用技术"><span>5.1、应用技术</span></a></h3>`,57),o={href:"https://vue-components-uat.ruijie.com.cn/components/overview",target:"_blank",rel:"noopener noreferrer"},m={href:"https://micro-frontends.ice.work/",target:"_blank",rel:"noopener noreferrer"},b=i(`<h3 id="_5-2、模板内容" tabindex="-1"><a class="header-anchor" href="#_5-2、模板内容"><span>5.2、模板内容</span></a></h3><p>主应用（使用红色主题） + 子应用（默认蓝色主题）</p><h1 id="_6、常见问题解决" tabindex="-1"><a class="header-anchor" href="#_6、常见问题解决"><span>6、常见问题解决</span></a></h1><h3 id="_6-1、在主应用和子应用多次切换时-主应用会出现样式丢失问题" tabindex="-1"><a class="header-anchor" href="#_6-1、在主应用和子应用多次切换时-主应用会出现样式丢失问题"><span>6.1、在主应用和子应用多次切换时，主应用会出现样式丢失问题</span></a></h3><p>这个问题是由于子应用运行在 <code>boostrap</code> 阶段，此时加载的样式会被 <code>patch</code> 记录，并在 <code>rebuild</code> 阶段还原。 懒加载组件运行在 <code>mounting</code> 阶段，此时加载的样式只会被记录一次。 所以在第一次切换时，会被 <code>rebuild</code> 还原，但是此时记录将被清空。 在超过两次的切换后，组件样式不再加载，无法添加新的记录，导致无法进行 <code>rebuild</code>，最终导致样式丢失。</p><p>解决方案：主应用加载组件，不使用路由懒加载</p><h3 id="_6-2、子站图片地址加载失败" tabindex="-1"><a class="header-anchor" href="#_6-2、子站图片地址加载失败"><span>6.2、子站图片地址加载失败</span></a></h3><p>图片地址是相对地址，导致 dom 节点图片真实地址指向主站，导致图片加载失败</p><p>解决方案：在子站配置 server 的 origin 是图片在地址显示为完整的路径地址</p><p>在vite.config.js 中新增配置如下</p><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">  server: {</span>
...
<span class="line">  &lt;/div&gt;</span>
<span class="line">&lt;/template&gt;</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、在 vite.config.js 中配置 less 变量</p><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">  css: {</span>
...
<span class="line">    },</span>
<span class="line">  },</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-4、频繁切换主应用界面和子应用界面-子应用不显示" tabindex="-1"><a class="header-anchor" href="#_6-4、频繁切换主应用界面和子应用界面-子应用不显示"><span>6.4、频繁切换主应用界面和子应用界面，子应用不显示</span></a></h3><p>在切换主站界面和子站界面时，子站跳转主站界面会执行 unmount 进行卸载，在次访问子站时数据存在缓存，contaniner 存在 dom 结构，导致子站执行 mount 失败</p><p>解决方案：在 vue 挂在的时候通过 id 值进行挂载</p><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">let app = null;</span>
<span class="line"> </span>
<span class="line">export function mount ({ container }) {</span>
<span class="line">  app = createApp(App);</span>
<span class="line">  app.use(router);</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-5、子站下载本地的静态文件" tabindex="-1"><a class="header-anchor" href="#_6-5、子站下载本地的静态文件"><span>6.5、子站下载本地的静态文件</span></a></h3><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">import templateXlsx from &#39;@/assets/文件.xlsx&#39;;</span>
<span class="line"></span>
