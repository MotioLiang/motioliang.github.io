import{_ as d,c as p,a as n,b as a,d as i,e as l,o as c,r}from"./app-Dk1LVsto.js";const t={},v={href:"https://github.com/ice-lab/icestark",target:"_blank",rel:"noopener noreferrer"},u={href:"https://vue-components-uat.ruijie.com.cn/components/overview",target:"_blank",rel:"noopener noreferrer"},o={href:"https://micro-frontends.ice.work/",target:"_blank",rel:"noopener noreferrer"};function m(b,s){const e=r("ExternalLinkIcon");return c(),p("div",null,[s[6]||(s[6]=n("h3",{id:"_1-1、介绍",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-1、介绍"},[n("span",null,"1.1、介绍")])],-1)),n("p",null,[n("a",v,[s[0]||(s[0]=a("icestark")),i(e)]),s[1]||(s[1]=a(" 是一个面向大型系统的微前端解决方案，适用于以下业务场景："))]),s[7]||(s[7]=l(`<ul><li>后台比较分散，体验差别大，因为要频繁跳转导致操作效率低，希望能统一收口的一个系统内</li><li>单页面应用非常庞大，多人协作成本高，开发/构建时间长，依赖升级回归成本高</li><li>系统有二方/三方接入的需求</li></ul><p><img src="https://s2.loli.net/2024/06/29/MyXdKEZ6eqp3CRh.png" alt="2.png"></p><h3 id="_1-2、项目结构" tabindex="-1"><a class="header-anchor" href="#_1-2、项目结构"><span>1.2、项目结构</span></a></h3><h1 id="_2、icestark-工作流程" tabindex="-1"><a class="header-anchor" href="#_2、icestark-工作流程"><span>2、icestark 工作流程</span></a></h1><p>icestark 目前支持三种加载模式，分别是 <code>script</code>、<code>fetch</code> 和 <code>import</code></p><ul><li><code>script</code></li></ul><p>默认加载方式。该模式下，icestark 会通过 HTML script 标签加载微应用脚本资源，再次加载时充分利用浏览器缓存进行加载。</p><ul><li><code>fetch</code></li></ul><p>当指定 loadScriptMode 为 fetch，或配置微应用沙箱模式时，会通过 window.fetch 或用户自定义的 fetch 能力 加载并缓存脚本资源。再次加载时，会充分利用本地内部缓存进行加载。</p><ul><li><code>import</code></li></ul><p>加载 ES modules 类型微应用的主要方式，该模式会通过 Dynamic Import 动态加载脚本资源。</p><p>推荐使用 <code>import</code> 当前项目模板也是采用 <code>import</code> 模式进行加载微应用</p><p><img src="https://s2.loli.net/2024/06/23/FTCl21fnpikmBwG.jpg" alt="icestark.jpg"></p><h3 id="_2-1、项目结构图" tabindex="-1"><a class="header-anchor" href="#_2-1、项目结构图"><span>2.1、项目结构图</span></a></h3><p><img src="https://s2.loli.net/2024/06/29/ysAuXbQ2dVmfUB4.png" alt="1.png"></p><h1 id="_3、vue-主应用接入" tabindex="-1"><a class="header-anchor" href="#_3、vue-主应用接入"><span>3、Vue 主应用接入</span></a></h1><h3 id="_3-1、主应用框架目录规范" tabindex="-1"><a class="header-anchor" href="#_3-1、主应用框架目录规范"><span>3.1、主应用框架目录规范</span></a></h3><div class="language-Shell line-numbers-mode" data-highlighter="prismjs" data-ext="Shell" data-title="Shell"><pre class="language-Shell"><code><span class="line">── project-name                      项目名称</span>
...
<span class="line">   ···</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2、安装-icestark-依赖" tabindex="-1"><a class="header-anchor" href="#_3-2、安装-icestark-依赖"><span>3.2、安装 icestark 依赖</span></a></h3><div class="language-Shell line-numbers-mode" data-highlighter="prismjs" data-ext="Shell" data-title="Shell"><pre class="language-Shell"><code><span class="line">npm i --save @ice/stark</span>
...
<span class="line">}</span>
<span class="line">&lt;/style&gt;</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_4、vue-微应用接入" tabindex="-1"><a class="header-anchor" href="#_4、vue-微应用接入"><span>4、Vue 微应用接入</span></a></h1><h3 id="_4-1、安装-icestark-依赖" tabindex="-1"><a class="header-anchor" href="#_4-1、安装-icestark-依赖"><span>4.1、安装 icestark 依赖</span></a></h3><div class="language-Shell line-numbers-mode" data-highlighter="prismjs" data-ext="Shell" data-title="Shell"><pre class="language-Shell"><code><span class="line">npm i @ice/stark @ice/stark-app -S</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h3 id="_4-2、安装-vite-plugin-index-html" tabindex="-1"><a class="header-anchor" href="#_4-2、安装-vite-plugin-index-html"><span>4.2、安装 vite-plugin-index-html</span></a></h3><div class="language-SQL line-numbers-mode" data-highlighter="prismjs" data-ext="SQL" data-title="SQL"><pre class="language-SQL"><code><span class="line">npm i vite-plugin-index-html  -D</span>
